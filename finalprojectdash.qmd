...
This graph provides a distribution of currently monitored asteroids based on their Palermo scale rating. This scale is designed for comparing the likelihood of an object's possible impact with the average risk posed by objects of similar or larger size over the range of years until the possible impact of the first object, which is known as the *background risk*. The Palermo scale is best understood as:

- **Values less than -2**: Minimal to no risk
- **Values between -2 to 0**: Risk worth careful consideration
- **Values greater than 0**: Serious concern for risk
  
At current, no monitored objects are considered a **serious concern**.
...
```{r}
#| label: m7-bar-chart-update
#| warning: false
#| fig-cap: "Distribution of monitored objects across Palermo Scale risk categories"
...
risk_long$scale <- recode(
  risk_long$scale,
  ps_cum_cat = "Cumulative",
  ps_max_cat = "Maximum"
)

risk_long$category <- factor(
  risk_long$category,
  levels = c("<=-6", ">-4 to =-6", ">-2 to =-4", ">0 to =-2", ">0")
)
...
ggplot(risk_counts,
  ...
  labs(
    ...
    y = "Number of Objects",
    fill = "Palermo Scale",
    title = "Relative Risk Distribution of Monitored Near-Earth Objects",
    subtitle = "Comparison of cumulative and maximum Palermo Scale values"
  ) +
...
#| label: des-breakdown
#| include: false
# This is my playground for trying to standardize tile size.
...
value_box(
  ...
  height = "150px",
  p(
    "Half-Month Code — 2nd Half of December",
    style = "font-size: 0.75rem; font-style: italic; margin-bottom: 0;"
  )
),
value_box(
  ...
  height = "150px",
  p(
    "Sequence Subscript — 117th Designation That Half-Month",
    style = "font-size: 0.75rem; font-style: italic; margin-bottom: 0;"
  )
),
value_box(
  ...
  height = "150px",
  p(
    "Peak Probability — Recorded Jan 2025",
    style = "font-size: 0.75rem; font-style: italic; margin-bottom: 0;"
  )
),
value_box(
  ...
  height = "150px",
  p(
    "Current Probability — Revised Mar 2026",
    style = "font-size: 0.75rem; font-style: italic; margin-bottom: 0;"
  )
)
)
