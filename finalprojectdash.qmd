...
# To convert to long format for comparison
...
# To order categories logically
risk_long$category <- factor(
  risk_long$category,
  levels = c(">0", ">0 to =-2", ">-2 to =-4", ">-4 to =-6", "<=-6")
)

# To count objects per category
